...
def build_model(cfg):
    ...
    if temp_cfg["temperature_state"] is True:
        temperature = models.Temperature(IdentityEncoder(),\
                    temp_cfg["hidden_dim"],temp_cfg["n_hidden"],temp_cfg["device"])
...
def build_actor_updater(cfg):
    ...
    if actor_cfg["name"] == "DiffusionMaximumAPosterioriPolicyOptimization":
        ...
        return updaters.DiffusionMaximumAPosterioriPolicyOptimization(
            ...
            temperature_dependent =actor_cfg['temperature_state']
