...
def build_model(cfg):
    ...
    return models.DiffusionActorTwinCriticWithTargets(
        actor=actor,
        critic=critic,
...
def build_actor_updater(cfg):
    ...
    if actor_cfg["name"] == "DiffusionMaximumAPosterioriPolicyOptimization":
        ...
        return updaters.TwinCriticDiffusionMaximumAPosterioriPolicyOptimization(
...
def build_critic_updater(cfg):
    ...
    if critic_cfg["name"] == "DiffusionExpectedSARSA":
        ...
        # Create the updater
        return updaters.TwinCriticDiffusionExpectedSARSA(
